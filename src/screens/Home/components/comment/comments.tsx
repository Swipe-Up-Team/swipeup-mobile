      ...
      <View style={styles.commentSection}>
        ...
        <View style={styles.row}>
          <Text numberOfLines={1} style={styles.lightText}>
            {moment(createdAt).format('MMMM DD')} at {moment(createdAt).format('h:mm a')}
          </Text>
...
export const Comments = ({ post, visible, onDismiss }) => {
  ...
  return (
    <BottomSheet visible={visible} onDismiss={onDismiss} scrollY={scrollY}>
      {loading ? (
