...
import { View, StyleSheet, Modal, Animated, PanResponder } from 'react-native'
import { SCREEN_HEIGHT } from '../../constants'

export const BottomSheet = ({ visible, children, onDismiss, scrollY }) => {
  ...
  return (
    <Modal animated visible={visible} transparent onRequestClose={handleDismiss}>
